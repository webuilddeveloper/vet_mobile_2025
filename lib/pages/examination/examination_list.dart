...
class ExaminationList extends StatefulWidget {
  ExaminationList({Key? key, this.title}) : super(key: key);

  final String? title;

  @override
  _ExaminationList createState() => _ExaminationList();
}

class _ExaminationList extends State<ExaminationList> {
  ...
  void _onLoading() async {
    ...
    setState(() {
      ...
      _futureCategory = service.postCategory(
        '${service.examinationCategoryApi}read',
        {
          'skip': 0,
          'limit': 100,
      ...
      examination = new ExaminationListVertical(
        site: "VET",
        model: service.postDio('${service.examinationApi}read', {
          'skip': 0,
          'limit': _limit,
          'category': category,
          'keySearch': keySearch
        ...
        url: '${service.examinationApi}read',
        urlGallery: service.examinationGalleryApi,
        callBack: () => {_onLoading()},
      );
    });
    // }
        ...
        body: NotificationListener<OverscrollIndicatorNotification>(
          ...
          child: InkWell(
            ...
            child: Column(
              ...
              children: [
                // SubHeader(th: "ข่าวสารประชาสัมพันธ์", en: "Examination"),
                SizedBox(height: 5),
                CategorySelector(
