...
import 'package:vet/pages/examination/examination_form.dart';
import 'package:vet/shared/api_provider.dart';
import 'package:vet/shared/extension.dart';

class ExaminationListVertical extends StatefulWidget {
  ExaminationListVertical(
      {Key? key,
      this.site,
      this.model,
      this.title,
  ...
  @override
  _ExaminationListVertical createState() => _ExaminationListVertical();
}

class _ExaminationListVertical extends State<ExaminationListVertical> {
                  ...
                  return InkWell(
                    onTap: () {
                      snapshot.data[index]['status2']
                          ? toastFail(context: context, text: 'คุณตอบแบบสอบถามนี้แล้ว')
                          : Navigator.push(
                              context,
                              MaterialPageRoute(
                                              ...
                                              ? Container(
                                                  ...
                                                  child: Column(
                                                    children: [
                                                      ...
                                                      Text(
                                                        '${snapshot.data[index]['points']} / ${snapshot.data[index]['totalPoints']}',
                                                        maxLines: 2,
                                                        overflow: TextOverflow
                                                            .ellipsis,
                                                        style: TextStyle(
