...
class _LoginAndRegisterPageState extends State<LoginAndRegisterPage> {
  ...
  _buildThaiDButton() {
    return Material(
      ...
      color: Color.fromARGB(
        ...
        55,
        72,
      ), // ใช้ RGB และกำหนดค่า Alpha = 255 (ทึบเต็มที่)
      child: MaterialButton(
        ...
        child: Row(
          ...
          children: [
            Image.asset('assets/images/icon_thaiID.png', width: 30),
            SizedBox(width: 5),
            Text(
              'แอปพลิเคชัน ThaID',
              style: TextStyle(
  ...
  _buildCardSelected() {
    return Column(
      children: [
        Row(children: [_widgetText(title: 'เข้าสู่ระบบผ่านบัญชีโชเชียล')]),
        _buildLoginSocial(),
        ...
        Row(children: [_widgetText(title: 'เข้าสู่ระบบผ่านบัญชี')]),
        SizedBox(height: 5.0),
        labelTextField(
          'ชื่อผู้ใช้งาน',
          Icon(Icons.person, color: Color(0xFF99722F), size: 20.00),
        ),
        SizedBox(height: 5.0),
        textFieldLogin(
          model: txtUsername,
        ...
        labelTextField(
          'รหัสผ่าน',
          Icon(Icons.lock, color: Color(0xFF99722F), size: 20.00),
        ),
        SizedBox(height: 5.0),
